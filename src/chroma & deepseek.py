...
def generate_response_huggingface(results, question):
    ...
    prompt += "\n\nNo respondas con 'Lo siento', 'No tengo información' ni frases similares."
    prompt += "\n\nSi hay varias fechas sobre el mismo evento, prioriza la más reciente."
